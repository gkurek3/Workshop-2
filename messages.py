...
from password_functions import check_password
...
if __name__ == '__main__':
    try:
        cnx = connect(database="application_db", user="postgres", password="coderslab", host="localhost")
        cnx.autocommit = True
        cursor = cnx.cursor()
